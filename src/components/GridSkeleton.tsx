...
export const GridSkeleton = ({
    ...
    const skeletonItems = Array.from({length: itemCount}, (_, index) => (
        <div
            ...
            className={cn(
                ...
                showAnimation && "hover:shadow-lg hover:scale-[1.02] hover:border-gray-200"
            )}
        >
            {/* Image skeleton */}
    ...
    const FilterSkeleton = () => (
        <div className="space-y-6 p-4 bg-white rounded-xl border border-gray-100">
            {/* Filter title */}
...
// CSS for shimmer animation (add to your global CSS if using custom animations)
/*
@keyframes shimmer {
  0% {
