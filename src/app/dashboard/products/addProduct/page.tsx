...
const ColorEnum = z.enum(["BLACK", "WHITE", "RED", "BLUE", "GREEN", "YELLOW", "PINK", "ORANGE", "PURPLE"]);
...
const AddProduct: React.FC = () => {
  ...
  const availableColors = ["BLACK", "WHITE", "RED", "BLUE", "GREEN", "YELLOW", "PINK", "ORANGE", "PURPLE"];
      ...
      <Card className="w-full max-w-2xl p-8 shadow-lg">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            {errors['variant.colors'] && <p className="text-red-500 text-sm mt-1">{errors['variant.colors']}</p>}
          </div>
          ...
          <div className="space-y-2">
            ...
            {errors['variant.sizes'] && <p className="text-red-500 text-sm mt-1">{errors['variant.sizes']}</p>}
          </div>
          ...
          {mutation.isError && (
            <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded">
              Error: {mutation.error?.message || "Failed to add product"}
            </div>
          )}
        </form>
      </Card>
