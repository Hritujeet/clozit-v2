...
import { Order, Status } from "@/client/prisma";
...
async function page() {
    ...
    if (allOrders.length <= 0) {
        return (
            <div className="h-96 flex flex-col justify-center items-center w-full gap-2">
    ...
    return (
        <main
            className={
                "container mx-auto px-4 sm:px-8 md:px-16 lg:px-20 xl:px-32 mt-5 mb-10 min-h-[60vh]"
            }
        >
