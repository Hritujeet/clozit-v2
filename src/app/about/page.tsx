                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="group cursor-pointer">
                            <div className="overflow-hidden rounded-lg shadow-lg">
                                <Image
                                    src="https://images.unsplash.com/photo-1506629905607-765634cf4ebc?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                            ...
                            <div className="mt-6 text-center">
                                <h3 className="text-2xl font-bold text-gray-900 mb-2">Accessories</h3>
                                <p className="text-gray-600">Perfect finishing touches to complete your look</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        <div className="text-center">
                            <div className="mb-6">
                                <Image
                                    src="https://images.unsplash.com/photo-1494790108755-2616c0763e73?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
                        ...
                        <div className="text-center">
                            <div className="mb-6">
                                <Image
                                    ...
                                    alt="Emma Parker - Customer Experience Lead"
                                    width={200}
                                    height={200}
                                    className="rounded-full mx-auto object-cover shadow-lg"
                                />
